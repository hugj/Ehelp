...
@AILayout(R.layout.activity_home_sos)
public class HomeSOSActivity extends BaseFragment implements OnRapidFloatingButtonSeparateListener
...
//        }
    ...
    public void setList(){
        SOS = new HomeAdapter(getActivity(), user_id, 2, eventCache);

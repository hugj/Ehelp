...
public class IphoneTreeView extends ExpandableListView implements
	...
	public interface IphoneTreeHeaderAdapter {
		public static final int PINNED_HEADER_GONE = 0; //不显示header
		public static final int PINNED_HEADER_VISIBLE = 1; //在顶部显示header
		public static final int PINNED_HEADER_PUSHED_UP = 2;
		//如果头延伸超出所述第一显示元件的底部，向上推和剪辑
		/**
		 * 获取 Header 的状态
		 * @param groupPosition
		 * @param childPosition
	...
	private static final int MAX_ALPHA = 255; //ͼ��ͨ��
	...
	public void setHeaderView(View view) {
		...
		requestLayout(); //要求parent view重新调用他的onMeasure onLayout来对重新设置自己位置
	}

	private void registerListener() {
		setOnScrollListener(this); //屏幕滚动

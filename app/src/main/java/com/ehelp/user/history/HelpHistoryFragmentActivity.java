...
@AILayout(R.layout.activity_help_history_fragment)
public class HelpHistoryFragmentActivity extends BaseFragment implements OnRapidFloatingButtonSeparateListener
    ...
    public void init() {
        ...
        SOSList = (ListView)findViewById_(R.id.HisHelp);
...
//        }
    ...
    public void changewha(int wha_) {
        wha = wha_;
        eventCache = Help.getRemoteTitleList(1, wha);
        setList();
    }
    ...
    public void setList(){
        Help = new HistoryAdapter(getActivity(), user_id, wha, 1, eventCache);
